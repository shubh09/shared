...
double a1=(double)1/26.0;
double a2=(double)1/676.0;
class PalindromicSubstringsDiv1 {
	...
	double expectedPalindromes(vector <string> S1, vector <string> S2)
	{
		int i,j;
                string str,str2;
                int s1=sz(S1),s2=sz(S2);
                FOR(i,0,s1) str.append(S1[i]);
                FOR(i,0,s2) str.append(S2[i]);
                int n=sz(str);
                str2.pb(str[0]);
                FOR(i,1,n) str2.pb('*'),str2.pb(str[i]);
                n=sz(str2);
                cout<<str2<<endl;
                double ans=0;
                FOR(i,0,n)
...
//                        cout<<j<<':'<<endl;
                        ...
                        {
                            if (str2[i-j]=='?') prob*=a1,ans+=prob,cout<<"added a1"<<endl;
                            else
                            {
                                ans+=prob;
//                                cout<<"added 1"<<endl;
                        ...
                        else if (str2[i-j]=='?'||str2[i+j]=='?') prob*=a1,ans+=prob,cout<<"added a1"<<endl;
                        else break;
                    }
                }
                return ans;
